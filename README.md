...
Install a specific version.  `composer require globalpay/payment-gateway:2.2.4`
...
## Maintenance
If you need update the plugin to latest version execute: `composer update globalpay/payment-gateway` or `composer require globalpay/payment-gateway:2.2.4 for specific version.
