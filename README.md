...
Install a specific version.  `composer require globalpay/payment-gateway:2.3.0`
...
## Maintenance
If you need update the plugin to latest version execute: `composer update globalpay/payment-gateway` or `composer require globalpay/payment-gateway:2.3.0` for specific version.
